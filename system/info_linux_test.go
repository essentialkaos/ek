...
var utmpData = []byte{
	0x7, 0x0, 0x0, 0x0, 0xd5, 0x86, 0x2c, 0x0, 0x70, 0x74, 0x73, 0x2f, 0x30, 0x0, 0x0,
	0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0,
	0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x74, 0x73, 0x2f, 0x30, 0x6a, 0x6f, 0x68,
	0x6e, 0x64, 0x6f, 0x65, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0,
	0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x31, 0x39, 0x32,
	0x2e, 0x31, 0x36, 0x38, 0x2e, 0x32, 0x35, 0x34, 0x2e, 0x31, 0x30, 0x31, 0x0, 0x0, 0x0,
	0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0,
	0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0,
	0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0,
	0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0,
	...
	0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0,
	0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0,
	0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x2c, 0x9a, 0x2b, 0x68, 0x9d, 0x53, 0xa, 0x0,
	0x25, 0xcc, 0x44, 0xc, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0,
	0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0,
	0x0, 0x0, 0x0,
}
...
func (s *SystemSuite) TestUser(c *C) {
	...
	os.MkdirAll(ptsDevDir+"/pts", 0755)
	os.WriteFile(utmpDir+"/utmp", utmpData, 0644)
	os.WriteFile(ptsDevDir+"/pts/0", []byte("-"), 0644)

	utmpFile = utmpDir + "/utmp"
	devDir = ptsDevDir

	sess, err := Who()

	c.Assert(err, IsNil)
	c.Assert(sess, HasLen, 1)
	c.Assert(sess[0].Username, Equals, "johndoe")
	c.Assert(sess[0].Host, Equals, "192.168.254.101")
	c.Assert(sess[0].LoginTime.IsZero(), Equals, false)
	c.Assert(sess[0].LastActivityTime.IsZero(), Equals, false)
