...
func (s *ColorSuite) TestHex2RGB(c *C) {
	...
	c.Assert([]int64{r, g, b}, DeepEquals, []int64{0, 0, 0})

	r, g, b = Hex2RGB(0xFFFFFF)
	c.Assert([]int64{r, g, b}, DeepEquals, []int64{0xFF, 0xFF, 0xFF})

	r, g, b = Hex2RGB(0x7F7F7F)
	c.Assert([]int64{r, g, b}, DeepEquals, []int64{0x7F, 0x7F, 0x7F})
...
func (s *ColorSuite) TestHex2RGBA(c *C) {
	...
	c.Assert([]int64{r, g, b, a}, DeepEquals, []int64{0, 0, 0, 0})

	r, g, b, a = Hex2RGBA(0xFFFFFFFF)
	c.Assert([]int64{r, g, b, a}, DeepEquals, []int64{0xFF, 0xFF, 0xFF, 0xFF})

	r, g, b, a = Hex2RGBA(0x7F7F7F7F)
	c.Assert([]int64{r, g, b, a}, DeepEquals, []int64{0x7F, 0x7F, 0x7F, 0x7F})
}
...
func (s *ColorSuite) TestRGB2HSB(c *C) {
	...
	c.Assert([]int64{h, sv, b}, DeepEquals, []int64{0, 0, 0})

	h, sv, b = RGB2HSB(255, 255, 255)
	c.Assert([]int64{h, sv, b}, DeepEquals, []int64{0, 0, 100})

	h, sv, b = RGB2HSB(255, 0, 0)
	c.Assert([]int64{h, sv, b}, DeepEquals, []int64{0, 100, 100})

	h, sv, b = RGB2HSB(0, 255, 0)
	c.Assert([]int64{h, sv, b}, DeepEquals, []int64{120, 100, 100})

	h, sv, b = RGB2HSB(0, 0, 255)
	c.Assert([]int64{h, sv, b}, DeepEquals, []int64{240, 100, 100})

	h, sv, b = RGB2HSB(127, 127, 127)
	c.Assert([]int64{h, sv, b}, DeepEquals, []int64{0, 0, 50})
}
...
func (s *ColorSuite) TestHSB2RGB(c *C) {
	...
	c.Assert([]int64{r, g, b}, DeepEquals, []int64{255, 0, 0})

	r, g, b = HSB2RGB(0, 100, 100)
	c.Assert([]int64{r, g, b}, DeepEquals, []int64{255, 0, 0})

	r, g, b = HSB2RGB(65, 50, 50)
	c.Assert([]int64{r, g, b}, DeepEquals, []int64{122, 128, 64})

	r, g, b = HSB2RGB(125, 50, 50)
	c.Assert([]int64{r, g, b}, DeepEquals, []int64{64, 128, 69})

	r, g, b = HSB2RGB(185, 50, 50)
	c.Assert([]int64{r, g, b}, DeepEquals, []int64{64, 122, 128})

	r, g, b = HSB2RGB(245, 50, 50)
	c.Assert([]int64{r, g, b}, DeepEquals, []int64{69, 64, 128})

	r, g, b = HSB2RGB(305, 50, 50)
	c.Assert([]int64{r, g, b}, DeepEquals, []int64{128, 64, 122})
}
