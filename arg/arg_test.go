...
func (s *ArgUtilSuite) TestGlobal(c *C) {
	...
	c.Assert(GetI("i:int"), Equals, -1)
	c.Assert(GetF("f:float"), Equals, -1.0)
...
func (s *ArgUtilSuite) TestGetters(c *C) {
	...
	c.Assert(args.GetI("_not_exist_"), Equals, -1)
	c.Assert(args.GetB("_not_exist_"), Equals, false)
	c.Assert(args.GetF("_not_exist_"), Equals, -1.0)
	...
	c.Assert(args.GetI("string"), Equals, -1)
	c.Assert(args.GetF("string"), Equals, -1.0)
	c.Assert(args.GetB("empty-string"), Equals, false)
	c.Assert(args.GetI("empty-string"), Equals, -1)
	c.Assert(args.GetF("empty-string"), Equals, -1.0)
	c.Assert(args.GetB("not-set-string"), Equals, false)
	c.Assert(args.GetI("not-set-string"), Equals, -1)
	c.Assert(args.GetF("not-set-string"), Equals, -1.0)
	...
	c.Assert(args.GetI("empty-bool"), Equals, -1)
	c.Assert(args.GetB("empty-bool"), Equals, false)
	c.Assert(args.GetF("empty-bool"), Equals, -1.0)
	c.Assert(args.GetS("not-set-bool"), Equals, "false")
	c.Assert(args.GetI("not-set-bool"), Equals, -1)
	c.Assert(args.GetB("not-set-bool"), Equals, false)
	c.Assert(args.GetF("not-set-bool"), Equals, -1.0)
